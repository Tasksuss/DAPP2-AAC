...
import math
import re
#from watchereye_tracking import inputnumber,main as INPUT
import socket
...
### ---------- receive ----------
    def receive_cmd(self, cmd_str: str) -> None:
        """RegionReceiver -> Tk 主线程"""
        self.root.after(0, self.process_command, cmd_str)
...
def main():
    ...
    # 把 GUI 的回调给 socket 线程
    receiver = RegionReceiver(callback=app.receive_cmd)
    receiver.start()
